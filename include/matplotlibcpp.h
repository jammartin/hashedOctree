...
// splitting plot3 function into parts to be able to plot multiple line objects into one figure
PyObject* build_plot3_obj()
{
    detail::_interpreter::get();
...
// Not sure if this is actually needed but can't hurt I guess
void cleanup_plot3(PyObject *plot3){
    Py_DECREF(plot3);
}
